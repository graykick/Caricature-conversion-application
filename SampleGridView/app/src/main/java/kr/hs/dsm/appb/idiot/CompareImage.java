...
public class CompareImage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**    객체 생성 부분   **/
        final Face_Type_Path faceTypePath = new Face_Type_Path();
        final Imgread_Type_Path imgreadTypePath = new Imgread_Type_Path();
        final Compare_Type_Rect compareTypeRect = new Compare_Type_Rect();
        final Compare_Type_Var compareTypeVar = new Compare_Type_Var();
        final Final_Type_INT finalTypeInt = new Final_Type_INT();
        final FaceCompare faceCompare = new FaceCompare();
        final EyeCompare eyeCompare = new EyeCompare();
        final MouthCompare mouthCompare = new MouthCompare();
        final NoseCompare noseCompare = new NoseCompare();
        ...
        //get face long data from intent
        ...
        System.out.println("BtFace Size = "+copyBtFace.getWidth()+", "+copyBtFace.getHeight());
        ...
        copyBtEye = getResizedBitmap(copyBtEye, copyBtEye.getWidth()/10, copyBtEye.getHeight()/10 );
        ...
        copyBtLips = getResizedBitmap(copyBtLips, copyBtLips.getWidth()/10, copyBtLips.getHeight()/10 );
...
//        copyBtHair = BtHair.copy(Bitmap.Config.ARGB_8888, true);
       ...
       // int eyebroRX = eyeRX;
        ...
        pasteImage(copyBtFace, copyBtLips, (int)lipX, (int)lipY);
        pasteImage(copyBtFace, copyBtNose, (int)noseX, (int)noseY);
        pasteImage(copyBtFace, copyBtEye, (int)eyeRX, (int)eyeRY);
        pasteImage(copyBtFace, chage(copyBtEye, 2), (int)eyeLX, (int)eyeLY);
...
class Face_Type_Path {
    ...
    protected String hair_Path = sd + "/" + "CCCam_Picture" + "/" + "hair" + "/" + "hair";
}
